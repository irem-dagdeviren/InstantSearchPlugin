...
namespace Nop.Plugin.InstantSearch.Controllers
{
  public class InstantSearchController : Base7SpikesPublicController
  {
      ...
      int vendorId)
    {
      ...
      bool flag = num != 0;
      IEnumerable<ProductOverviewModel> productOverviewModels = await searchController._productModelFactory.PrepareProductOverviewModelsAsync((IEnumerable<Product>) products, true, true, new int?(searchController._instantSearchSettings.PictureSize), flag, false);
