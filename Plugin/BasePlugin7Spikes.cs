...
namespace Nop.Plugin.InstantSearch.Plugin
{
  public abstract class BasePlugin7Spikes : BasePlugin
  {
    ...
    protected BasePlugin7Spikes(string pluginFolderName) => this.PluginFolderName = pluginFolderName;
    ...
    private async Task<SiteMapNode> EnsureMainMenuInitializedAsync(SiteMapNode rootNode)
    {
      ...
      string resourceAsync1 = await ilocalizationService.GetResourceAsync("Nop.Plugin.Admin.Menu.MainMenu", ((BaseEntity) await this.WorkContext.GetWorkingLanguageAsync()).Id, true, "Nop-Templates", false);
      ...
      string resourceAsync2 = await ilocalizationService.GetResourceAsync("Nop.Plugin.Admin.Menu.Plugins.MenuName", ((BaseEntity) await this.WorkContext.GetWorkingLanguageAsync()).Id, true, "Plugins", false);
      ilocalizationService = (ILocalizationService) null;
      string pluginsTitle = resourceAsync2;
      ilocalizationService = this.LocalizationService;
      string resourceAsync3 = await ilocalizationService.GetResourceAsync("Nop.Plugin.Admin.Menu.Themes.MenuName", ((BaseEntity) await this.WorkContext.GetWorkingLanguageAsync()).Id, true, "Themes", false);
      ilocalizationService = (ILocalizationService) null;
      string templatesTitle = resourceAsync3;
      ilocalizationService = this.LocalizationService;
      string resourceAsync4 = await ilocalizationService.GetResourceAsync("Nop.Plugin.Admin.Menu.PluginsAccessControl.MenuName", ((BaseEntity) await this.WorkContext.GetWorkingLanguageAsync()).Id, true, "Plugins Access Control", false);
      ilocalizationService = (ILocalizationService) null;
      string accessControlTitle = resourceAsync4;
      ilocalizationService = this.LocalizationService;
      string resourceAsync5 = await ilocalizationService.GetResourceAsync("Nop.Plugin.Admin.Menu.Warnings.MenuName", ((BaseEntity) await this.WorkContext.GetWorkingLanguageAsync()).Id, true, "Warnings", false);
      ilocalizationService = (ILocalizationService) null;
      string warningsTitle = resourceAsync5;
      ilocalizationService = this.LocalizationService;
      string resourceAsync6 = await ilocalizationService.GetResourceAsync("Nop.Plugin.Admin.Menu.Information.MenuName", ((BaseEntity) await this.WorkContext.GetWorkingLanguageAsync()).Id, true, "Information", false);
      ilocalizationService = (ILocalizationService) null;
